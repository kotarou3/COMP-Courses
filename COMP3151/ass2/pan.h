...
#define _nstates2	7	/* reads_finish */
#define minseq2	154
#define maxseq2	159
#define _endstate2	6

#define _nstates1	80	/* reader */
#define minseq1	75
#define maxseq1	153
#define _endstate1	79

#define _nstates0	76	/* writer */
#define minseq0	0
#define maxseq0	74
...
typedef struct P2 { /* reads_finish */
...
#define Air1	(sizeof(P1) - Offsetof(P1, _2_8_value_int) - 1*sizeof(int))

#define Pwriter	((P0 *)this)
...
#define Air0	(sizeof(P0) - Offsetof(P0, b) - 1*sizeof(int))
